...
<html lang="en">
   ...
   <body>
         ...
         <div class="banner_wrapper">
            ...
            <div class="container">
               <div class="banner_text">
                  <h2 class="banner-title">B737 Type Specific Training course</h2>
               </div>
            </div>
         </div>
      </section>
      <section class="categoryPage_Wrapper">
         <div class="container">
            <div class="about-us">
               <h4>Type Rating Training:</h4>
               <span>B 737 NG Type Rating Course</span>
               <span>B 737 NG Type Rating Course including JIT</span>
               <span>B 737 NG Type Rating Course including JIT and MCC</span>
               <h4> Cooperation</h4>
               <span>B737 Standard Type Rating Training</span>
               <h4>Recurrent Training:</h4>
               <span>B 737 NG Refresher Training Course</span>
               <span>B 737 NG Extended Refresher Training Course</span>
               <h4>Transition Training:</h4>
               <span>Integrated Transition Course</span>
               <span>Type Rating plus Jet Orientation Training and Multi Crew Cooperation</span>
             </div>
         </div>
      </section>
