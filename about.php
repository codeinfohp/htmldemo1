         ...
         <div class="banner_wrapper">
            ...
            <div class="container">
               <div class="banner_text">
                  <h2 class="banner-title">ABOUT CSTPL</h2>
               </div>
            </div>
         </div>
      </section>
      <section class="categoryPage_Wrapper">
         <div class="container">
            ...
            <div class="staticPage">
               <p>Indian DGCA approved A320 ATO (Approved Training Organization) under CAP 7100 with 5 Level “D” A320
                  Full Flight Simulators
               </p>
               <p>CSTPL provide world class Ground School Training with a strong pool of Ground School Instructors</p>
               <p>CSTPL caters to provide Pilot Selection Tools in form of COMPASS and ADAPT</p>
            </div>
            <div class="heading">
               <h2 class="h2">MISSION, VISION AND VALUES</h2>
            </div>
            <div class="about-us">
               <h4>MISSION</h4>
               <span>“Building Greater Value Together”</span>
               <h4> VISION</h4>
               <span>To provide A320 Type Specific Training courses and innovative solutions to enable our customers to
               maximize their performance and results </span>
               <h4>VALUES</h4>
               <span>At CAE Simulation Training Private Limited, we cherish our values and strive to uphold these
               values every day and in every way</span>
            </div>
         </div>
      </section>
